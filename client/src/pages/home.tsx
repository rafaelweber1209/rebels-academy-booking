...
import heroImage from "@assets/generated_images/Hero_smartphone_app_mockup_625fbb5b.png";
import generatorImage from "@assets/generated_images/AI_program_generator_screenshot_8cd997b5.png";
import recoveryImage from "@assets/generated_images/Recovery_tracking_dashboard_screenshot_8e4c7b49.png";
import adviceImage from "@assets/generated_images/Progressive_overload_advice_screenshot_f43a7a77.png";
import coachImage from "@assets/generated_images/AI_coach_dashboard_screenshot_d995d39d.png";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-lg bg-background/80 border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={logoImage} alt="MuscleCoach Logo" className="h-10 w-10" data-testid="img-logo" />
            <span className="text-2xl font-bold text-foreground">MuscleCoach</span>
          </div>
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8 animate-fade-in-up">
                <div className="space-y-6">
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight" data-testid="text-hero-title">
              ...
              <div className="relative flex justify-center animate-fade-in" style={{ animationDelay: '0.3s', opacity: 0, animationFillMode: 'forwards' }} data-testid="container-hero-image">
                <div className="relative w-72 md:w-80 lg:w-96 animate-float">
        ...
        <section id="problem-cause" className="py-20 md:py-32 bg-card/30 relative">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6 mb-16">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed" data-testid="text-problem-subtitle">
              ...
              <h3 className="text-2xl font-semibold pt-4" data-testid="text-valkuilen-intro">
                Dit leidt tot de drie meest voorkomende 'valkuilen':
              </h3>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-8 space-y-4 hover-elevate active-elevate-2" data-testid="card-valkuil-1">
                <div className="w-14 h-14 rounded-lg bg-primary/10 flex items-center justify-center">
                  <Target className="w-7 h-7 text-primary" />
                </div>
                <h3 className="text-2xl font-bold">Statische Schema's</h3>
              ...
              <Card className="p-8 space-y-4 hover-elevate active-elevate-2" data-testid="card-valkuil-2">
                <div className="w-14 h-14 rounded-lg bg-primary/10 flex items-center justify-center">
                  <Zap className="w-7 h-7 text-primary" />
                </div>
                <h3 className="text-2xl font-bold">Program-hopping</h3>
                <p className="text-muted-foreground leading-relaxed">
                  Constant wisselen van schema's reset je adaptatie. Zonder consistente, progressieve overload blijft echte spiergroei uit.
                </p>
              </Card>

              <Card className="p-8 space-y-4 hover-elevate active-elevate-2" data-testid="card-valkuil-3">
                <div className="w-14 h-14 rounded-lg bg-primary/10 flex items-center justify-center">
                  <Activity className="w-7 h-7 text-primary" />
                </div>
                <h3 className="text-2xl font-bold">Simpele Tracking Apps</h3>
                <p className="text-muted-foreground leading-relaxed">
        ...
        <section id="features" className="py-20 md:py-32 relative">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6 mb-16">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed" data-testid="text-features-subtitle">
              ...
              <Card className="overflow-hidden hover-elevate" data-testid="card-feature-generator">
                ...
                <div className="p-8 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl font-bold">AI Program Generator</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <Card className="overflow-hidden hover-elevate" data-testid="card-feature-recovery">
                ...
                <div className="p-8 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl font-bold">Adaptief Herstel</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <Card className="overflow-hidden hover-elevate" data-testid="card-feature-overload">
                ...
                <div className="p-8 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl font-bold">Automatische Progressive Overload</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
              ...
              <Card className="overflow-hidden hover-elevate" data-testid="card-feature-coach">
                ...
                <div className="p-8 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl font-bold">Proactieve AI Coach</h3>
                  </div>
                  <p className="text-muted-foreground leading-relaxed">
        ...
        <section id="testimonials" className="py-20 md:py-32 bg-card/30 relative">
          <div className="absolute inset-0 bg-gradient-to-b from-background via-card/30 to-background pointer-events-none" />
          
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16" data-testid="text-testimonials-title">
              Wat onze gebruikers <span className="text-primary">zeggen</span>
            </h2>

            <div className="max-w-4xl mx-auto relative">
              <Card className="p-12 text-center space-y-6 hover-elevate" data-testid={`card-testimonial-${currentTestimonial}`}>
        ...
        <section id="cta" className="py-20 md:py-32 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
            ...
            <p className="text-lg md:text-xl text-muted-foreground" data-testid="text-cta-subtitle">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-4">
              ...
              >
                <div className="bg-card border border-border rounded-lg px-8 py-4 flex items-center gap-4 min-w-[200px]">
        ...
        <footer className="bg-card/50 border-t border-border py-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xl font-bold">MuscleCoach</span>
                </div>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li>
                    <button onClick={() => scrollToSection('features')} className="text-muted-foreground hover:text-primary transition-colors" data-testid="link-footer-features">
                      Features
                    </button>
                  </li>
                  <li>
            ...
            <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground" data-testid="text-copyright">
